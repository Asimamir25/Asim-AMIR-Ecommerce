  ...
  return (
    <div>
                    ...
                    {hoveredProduct === product.id ? (
                      <div className="flex gap-[20px] justify-center items-center mt-[30px]  ">
                        <div className="flex bg-btnbg justify-between items-center rounded-[19px] pr-[10px]   ">
                          ...
                          <div className="w-[50px] h-[50px] bg-[#EDA415] rounded-full flex justify-center items-center ">
                            <img src={basket} alt="" />
                          </div>
                        </div>
                        <div>
                    ...
                    {hoveredProduct === product.id ? (
                      <div className="flex gap-[20px] justify-center items-center mt-[30px]  ">
                        <div className="flex bg-btnbg justify-between items-center rounded-[19px] pr-[10px]   ">
                          ...
                          <div className="w-[30px] h-[30px] bg-[#EDA415] rounded-full flex justify-center items-center ">
                            <svg
                              width="18"
                              height="18"
                              viewBox="0 0 18 18"
      ...
      <div className="my-[30px] flex gap-1 items-center justify-center text-center  ">
        <div className="round w-4 h-4 bg-[#EDA415] rounded-full"></div>
